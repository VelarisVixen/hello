...
function Header() {
  const navLink =
    "text-[15px] font-medium text-foreground/80 hover:text-foreground transition-colors";
  return (
      ...
      <div className="container flex h-16 items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-6">
          <NavLink
            to="/about"
            className={({ isActive }) =>
              cn(navLink, isActive && "text-foreground")
            }
          >
            About us
          </NavLink>
  ...
  return (
    <footer className="border-t border-border bg-background">
      <div className="container py-12 grid grid-cols-1 md:grid-cols-3 gap-10">
        <div>
          <h3 className="text-[15px] font-semibold text-foreground/70 mb-3">
            Symptomate
          </h3>
          <ul className="space-y-2 text-foreground/80">
            ...
            <li>
              <a href="/assess" className="hover:text-foreground">
                Start assessing
              </a>
            </li>
            <li>
              <a
                href="https://infermedica.com/blog"
                target="_blank"
                rel="noreferrer"
            ...
            <li>
              <a
                href="https://infermedica.com/press"
                target="_blank"
                rel="noreferrer"
                className="hover:text-foreground"
              >
        ...
        <div>
          ...
          <ul className="space-y-2 text-foreground/80">
            <li>
              <a
                href="mailto:contact@symptomate.com"
                className="hover:text-foreground"
              >
            ...
            <li className="flex gap-4 pt-1">
              <a
                href="https://www.facebook.com/Symptomate/"
                target="_blank"
                rel="noreferrer"
                aria-label="Facebook"
              ...
              <a
                href="https://twitter.com/Symptomate"
                target="_blank"
                rel="noreferrer"
                aria-label="Twitter"
                className="hover:opacity-80"
              ...
              <a
                href="https://www.instagram.com/symptomate/"
                target="_blank"
                rel="noreferrer"
